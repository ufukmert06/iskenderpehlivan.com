...
class BlogResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Blog Yonetimi';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('categories')
                    ->label('Kategoriler')
                    ->relationship('categories', 'slug_base', fn (Builder $query) => $query->where('type', 'blog'))
                    ->multiple()
                    ->searchable()
                    ->preload()
                    ->createOptionForm([
                ...
                Forms\Components\Select::make('tags')
                    ->label('Etiketler')
                    ->relationship('tags', 'slug_base', fn (Builder $query) => $query->where('type', 'blog'))
                    ->multiple()
                    ->searchable()
                    ->preload()
                    ->createOptionForm([
