            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-main">
                        <div class="footer-left">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img id="logo_footer" src="/assets/images/logo/footer-logo.png" data-retina="./images/logo/footer-logo@2x.png" alt="">
                                </a>
                            </div>
                    ...
                    <div class="footer-bottom">
                        <p>Copyright © 2024 Healingy By <a href="https://themeforest.net/user/themesflat" target="_blank">ThemesFlat.com</a> All rights reserved</p>
